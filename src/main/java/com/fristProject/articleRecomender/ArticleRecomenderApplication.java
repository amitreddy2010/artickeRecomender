...
//        userRepository.resetUserTable();
     ...
     // Create a Post
        Post post0 = new Post(0,"AllianceBernstein - Hedged - Mdis",
        ...
        Post post1 = new Post(1,"Fidelity Asian High Yield Fund - Hedged",
        ...
        Post post2 = new Post(2,"First State Dividend Advantage Fund - Qdis",
                "The investment objective of the First State Dividend Advantage is to provide investors with regular distributions.",
                "1.0", "Equity", "SGD", "APxJ Equity", "5.32%", "7.48%", "17.66%", "11.33%");
        Post post3 = new Post(3,"Neuberger Berman High Yield Bond Fund - Mdis",
        ...
        Post post4 = new Post(4,"JPMorgan IF - Global Income - Hedged",
                "the fund aims to provide regular income by investing primarily in a portfolio of income generating securities.",
                "1.0", "Equity", "SGD", "Global Aggregate", "2.28%", "4.46%", "8.50%", "4.71%");
        Post post5 = new Post(5,"JPM Global Income - Hedged",
                "the fund aims to provide regular income by investing primarily in a portfolio of income generating securities.",
                "1.0", "Bonds", "SGD", "Global Balanced", "2.26%", "4.50%", "8.48%", "4.59%");
        Post post6 = new Post(6,"Jupiter Dynamic Bond Fund - Mdis",
                "The investment objective of the Fund is to achieve a high income with the prospect of capital growth.",
